...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a class="btn btn-primary" href="{{url('FormEmpleado')}}"><i class="fa fa-user-plus"></i> Crear Empleado</a>
                      ...
                      <tbody>
                         @foreach($todoempleados as $todo)
                            <tr>
                              ...
                              <td>
                                {{$todo->PrimerNombre}} {{$todo->SegundoNombre}} {{$todo->PrimerApellido}} {{$todo->SegundoApellido}}
                              </td>   
                              <td>
                                {{$todo->Telefono}}
                              </td> 
                              ...
                              <td>
                                <div class="hidden-sm hidden-xs action-buttons text-center">
                                  <a class="blue" href="{{url('PerfilEmpleado')}}/{{$todo->id_empleado}}">
                                    <i class="ace-icon fa fa-search-plus bigger-130 tooltip-info" data-rel="tooltip" title="Detalles"></i>
                                  </a>

                                  <a class="green" href="{{url('modificarEmpleado')}}/{{$todo->id_empleado}}">
                                    <i class="ace-icon fa fa-pencil bigger-130 tooltip-success" data-rel="tooltip" title="Editar"></i>
                                  </a>

                                  <a class="red" href="#" id="btn_eliminar" name="btn_eliminar" value="{{base64_encode($todo->identificacion)}}">
